...
//{c_void, c_int, c_uint, c_short, c_ushort, c_uchar, c_char};
...
pub type ut64 = c_ulonglong;
pub type st64 = c_longlong;
...
pub static UT64_MAX : c_ulonglong = 0xFFFFFFFFFFFFFFFF;
pub static UT64_GT0 : c_ulonglong = 0x8000000000000000;
pub static UT64_LT0 : c_ulonglong = 0x7FFFFFFFFFFFFFFF;
pub static UT64_MIN : c_ulonglong = 0;
pub static UT64_32U : c_ulonglong = 0xFFFFFFFF00000000;
pub static UT64_16U : c_ulonglong = 0xFFFFFFFFFFFF0000;
pub static UT64_8U : c_ulonglong =  0xFFFFFFFFFFFFFF00;
...
extern "C" {
	...
	pub fn r_core_init(core: *mut RCore) -> c_int;
	pub fn r_core_file_open(core: *mut RCore, file: *const c_char, mode : c_int, loadaddr : ut64 ) -> *mut c_void;
	pub fn r_core_bin_load(core: *mut RCore, file: *const c_char, baseaddr : ut64) -> c_int;
	pub fn r_core_cmd(core: *mut RCore, cmd: *const c_char, log: c_int) -> c_int;
	pub fn r_core_free (core :*mut RCore) -> *mut RCore;
}
